    ...
    int characterReplacement(string s, int k) {
        ...
        for (int i = 0; i < n + 1; ++i) {
            ...
            while (i - j + 1 - mostFrequent > k) {
                // This means that if the difference between 'Length of the current substring' and 'Most occurred char'
                // is greater than 'Max chars we can replace', then we need to start excluding the chars in our
